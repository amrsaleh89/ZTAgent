...
// -----------------------------------------
//
// Source: spiraltest1.java
// Date  : 07 Feb 2017 18:17:03 ECT
 ...
 * Automatically generated load test program.
 */
public class spiraltest1 extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	public static String USER_AGENT_1 = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.87 Safari/537.36";
	...
	private static final String EXTERNAL_PARAM_FILE = "spiraltest1ExtParams.dat";           // input file name for very large parameter values
	 ...
	 */
	public spiraltest1(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	boolean executePage_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		// verify response: status code = [verification disabled], content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 18386
		// content test algorithm: search text
		urlCallPassed = httpResponseOk(testURL, threadStep, null, "TEXT/HTML", null, "Touch styles for more information");		// Test [1] <- Index 1
		if (!urlCallPassed)
		{
		...
		String requestHost0002 = "104.199.121.153";
		int    requestPort0002 = 443;
		String requestFile0002 = "/css/account.css";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 212
		// content test algorithm: check size +/- 5%, defined content size = 212
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 212, 5);		// Test [2] <- Index 2
		if (!urlCallPassed)
		{
		...
		String requestHost0003 = "104.199.121.153";
		int    requestPort0003 = 443;
		String requestFile0003 = "/css/app.css";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 182850
		// content test algorithm: check size +/- 5%, defined content size = 182850
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 182850, 5);		// Test [3] <- Index 3
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0004 = "104.199.121.153";
		int    requestPort0004 = 443;
		String requestFile0004 = "/js/app.js";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 342631
		// content test algorithm: check size +/- 5%, defined content size = 342631
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 342631, 5);		// Test [4] <- Index 4
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0005 = "104.199.121.153";
		int    requestPort0005 = 443;
		String requestFile0005 = "/img/logo-new-beta.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 70797
		// content test algorithm: check size +/- 5%, defined content size = 70797
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 70797, 5);		// Test [5] <- Index 5
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0006 = "104.199.121.153";
		int    requestPort0006 = 443;
		String requestFile0006 = "/img/pinterest.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 6321
		// content test algorithm: check size +/- 5%, defined content size = 6321
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 6321, 5);		// Test [6] <- Index 6
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0007 = "104.199.121.153";
		int    requestPort0007 = 443;
		String requestFile0007 = "/img/lp_search.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 55896
		// content test algorithm: check size +/- 5%, defined content size = 55896
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 55896, 5);		// Test [7] <- Index 7
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0008 = "104.199.121.153";
		int    requestPort0008 = 443;
		String requestFile0008 = "/img/landing_page/do_you_know_your_learning_personality_new.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 859827
		// content test algorithm: check size +/- 5%, defined content size = 859827
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 859827, 5);		// Test [8] <- Index 8
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0009 = "104.199.121.153";
		int    requestPort0009 = 443;
		String requestFile0009 = "/img/landing_page/would_you_like_help_with_your_reading_new.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 1084799
		// content test algorithm: check size +/- 5%, defined content size = 1084799
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 1084799, 5);		// Test [9] <- Index 9
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0010 = "104.199.121.153";
		int    requestPort0010 = 443;
		String requestFile0010 = "/img/landing_page/do_you_know_you_reading_grade_level_new.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 1108977
		// content test algorithm: check size +/- 5%, defined content size = 1108977
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 1108977, 5);		// Test [10] <- Index 10
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0011 = "104.199.121.153";
		int    requestPort0011 = 443;
		String requestFile0011 = "/img/fb.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 4874
		// content test algorithm: check size +/- 5%, defined content size = 4874
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 4874, 5);		// Test [11] <- Index 11
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0012 = "104.199.121.153";
		int    requestPort0012 = 443;
		String requestFile0012 = "/img/video-bg.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 246682
		// content test algorithm: check size +/- 5%, defined content size = 246682
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 246682, 5);		// Test [12] <- Index 12
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0013 = "104.199.121.153";
		int    requestPort0013 = 443;
		String requestFile0013 = "/img/twitter.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 5843
		// content test algorithm: check size +/- 5%, defined content size = 5843
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 5843, 5);		// Test [13] <- Index 13
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0014 = "104.199.121.153";
		int    requestPort0014 = 443;
		String requestFile0014 = "/img/landing_page/do_you_want_to_save_your_childs_voice_recordings_forever_new.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 609031
		// content test algorithm: check size +/- 5%, defined content size = 609031
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 609031, 5);		// Test [14] <- Index 14
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0015 = "104.199.121.153";
		int    requestPort0015 = 443;
		String requestFile0015 = "/img/landing_page/are_you_a_teacher_who_wants_more%20visibility_of_student_reading_levels.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 705347
		// content test algorithm: check size +/- 5%, defined content size = 705347
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 705347, 5);		// Test [15] <- Index 15
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0016 = "104.199.121.153";
		int    requestPort0016 = 443;
		String requestFile0016 = "/img/landing_page/do_you_find_public_speaking_intimidating.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 792332
		// content test algorithm: check size +/- 5%, defined content size = 792332
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 792332, 5);		// Test [16] <- Index 16
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0017 = "104.199.121.153";
		int    requestPort0017 = 443;
		String requestFile0017 = "/img/landing_page/do_you_want_help_with_stuttering.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 605794
		// content test algorithm: check size +/- 5%, defined content size = 605794
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 605794, 5);		// Test [17] <- Index 17
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0018 = "104.199.121.153";
		int    requestPort0018 = 443;
		String requestFile0018 = "/img/landing_page/do_you_want_educational_search_content_that_is_tailored_to_you_new.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 980494
		// content test algorithm: check size +/- 5%, defined content size = 980494
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 980494, 5);		// Test [18] <- Index 18
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0019 = "104.199.121.153";
		int    requestPort0019 = 443;
		String requestFile0019 = "/img/logo.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 258045
		// content test algorithm: check size +/- 5%, defined content size = 258045
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 258045, 5);		// Test [19] <- Index 19
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0020 = "104.199.121.153";
		int    requestPort0020 = 443;
		String requestFile0020 = "/img/spiral-icon.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 18571
		// content test algorithm: check size +/- 5%, defined content size = 18571
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 18571, 5);		// Test [20] <- Index 20
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
	...
	boolean executePage_1_1(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0021 = "104.199.121.153";
		int    requestPort0021 = 443;
		String requestFile0021 = "/login";
		...
		// verify response: status code = [verification disabled], content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 12291
		// content test algorithm: search text
		urlCallPassed = httpResponseOk(testURL, threadStep, null, "TEXT/HTML", null, "ul class=\"nav navbar-nav navbar-right\"");		// Test [21] <- Index 21
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		log();
		log("# title: Redirecting to https://104.199.121.153/student/achivement");
		String requestProt0022 = "https";
		String requestHost0022 = "104.199.121.153";
		int    requestPort0022 = 443;
		String requestFile0022 = "/login";
		String requestContent0022 = 
				"_token=9SOwz03aNlUULkLCNXvbruk14riFxL0ebXIwaCcr" +
				"&email=test01s%40gmail.com" +
				"&password=123456";
		String requestHeader0022 = "POST " + requestFile0022 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				"Host: 104.199.121.153\r\n" + 
				"Connection: Keep-Alive\r\n" + 
				"Content-Length: " + requestContent0022.length() + "\r\n" + 		// Content-Length: 89
				"Origin: https://104.199.121.153\r\n" + 
				"Upgrade-Insecure-Requests: 1\r\n" + 
				"User-Agent: " + USER_AGENT_1 + "\r\n" + 
		...
		// verify response: status code = [verification disabled], content type = [verification disabled], header text fragment = [verification disabled], recorded content size = 412
		...
		String requestHost0023 = "104.199.121.153";
		int    requestPort0023 = 443;
		String requestFile0023 = "/student/achivement";
		...
		// verify response: status code = [verification disabled], content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 18544
		// content test algorithm: search text
		urlCallPassed = httpResponseOk(testURL, threadStep, null, "TEXT/HTML", null, "label for=\"reading_assessment_progress\"");		// Test [23] <- Index 23
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0024 = "104.199.121.153";
		int    requestPort0024 = 443;
		String requestFile0024 = "/css/kartik-v-bootstrap-star-rating/star-rating.min.css";
		...
		// verify response: status code = 200, content type = "TEXT/CSS", header text fragment = [verification disabled], recorded content size = 2040
		// content test algorithm: check size +/- 5%, defined content size = 2040
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "TEXT/CSS", null, 2040, 5);		// Test [24] <- Index 24
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0025 = "104.199.121.153";
		int    requestPort0025 = 443;
		String requestFile0025 = "/js/kartik-v-bootstrap-star-rating/star-rating.min.js";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 11642
		// content test algorithm: check size +/- 5%, defined content size = 11642
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 11642, 5);		// Test [25] <- Index 25
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0026 = "104.199.121.153";
		int    requestPort0026 = 443;
		String requestFile0026 = "/img/student/congra.gif";
		...
		// verify response: status code = 200, content type = "IMAGE/GIF", header text fragment = [verification disabled], recorded content size = 215192
		// content test algorithm: check size +/- 5%, defined content size = 215192
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/GIF", null, 215192, 5);		// Test [26] <- Index 26
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0027 = "104.199.121.153";
		int    requestPort0027 = 443;
		String requestFile0027 = "/fonts/bootstrap/glyphicons-halflings-regular.woff2";
		...
		// verify response: status code = 200, content type = "APPLICATION/OCTET-STREAM", header text fragment = [verification disabled], recorded content size = 18028
		// content test algorithm: check size +/- 5%, defined content size = 18028
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/OCTET-STREAM", null, 18028, 5);		// Test [27] <- Index 27
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0028 = "104.199.121.153";
		int    requestPort0028 = 443;
		String requestFile0028 = "/student";
		...
		// verify response: status code = [verification disabled], content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 13265
		// content test algorithm: search text
		urlCallPassed = httpResponseOk(testURL, threadStep, null, "TEXT/HTML", null, "Do you know your Learning Personality?");		// Test [28] <- Index 28
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0029 = "104.199.121.153";
		int    requestPort0029 = 443;
		String requestFile0029 = "/student/list";
		...
		// verify response: status code = [verification disabled], content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 48133
		// content test algorithm: search text
		urlCallPassed = httpResponseOk(testURL, threadStep, null, "TEXT/HTML", null, "Choose category resources Level 1");		// Test [29] <- Index 29
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0030 = "104.199.121.153";
		int    requestPort0030 = 443;
		String requestFile0030 = "/sound/Hello_Again.mp3";
		...
		// verify response: status code = 206, content type = "AUDIO/MPEG", header text fragment = [verification disabled], recorded content size = 926741
		// content test algorithm: check size +/- 5%, defined content size = 926741
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {206}, "AUDIO/MPEG", null, 926741, 5);		// Test [30] <- Index 30
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0031 = "104.199.121.153";
		int    requestPort0031 = 443;
		String requestFile0031 = "/student/show/1";
		...
		// verify response: status code = [verification disabled], content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 62874
		// content test algorithm: search text
		urlCallPassed = httpResponseOk(testURL, threadStep, null, "TEXT/HTML", null, "lookupObject[originalArray[i][prop]] = originalArray[i];");		// Test [31] <- Index 31
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0032 = "cdn.webrtc-experiment.com";
		int    requestPort0032 = 443;
		String requestFile0032 = "/RecordRTC.js";
		String requestHeader0032 = "GET " + requestFile0032 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				"Host: cdn.webrtc-experiment.com\r\n" + 
				"Connection: Keep-Alive\r\n" + 
				"User-Agent: " + USER_AGENT_1 + "\r\n" + 
				"Accept: */*\r\n" + 
				"DNT: 1\r\n" + 
		...
		// verify response: status code = [verification disabled], content type = [verification disabled], header text fragment = [verification disabled], recorded content size = 267
		// content test algorithm: none - no content check
		...
		String requestHost0033 = "cdn.webrtc-experiment.com";
		int    requestPort0033 = 443;
		String requestFile0033 = "/getScreenId.js";
		...
		// verify response: status code = [verification disabled], content type = [verification disabled], header text fragment = [verification disabled], recorded content size = 269
		// content test algorithm: none - no content check
		...
		String requestHost0034 = "cdn.webrtc-experiment.com";
		int    requestPort0034 = 443;
		String requestFile0034 = "/gif-recorder.js";
		...
		// verify response: status code = [verification disabled], content type = [verification disabled], header text fragment = [verification disabled], recorded content size = 270
		// content test algorithm: none - no content check
		...
		String requestHost0035 = "cdn.webrtc-experiment.com";
		int    requestPort0035 = 443;
		String requestFile0035 = "/gumadapter.js";
		...
		// verify response: status code = [verification disabled], content type = [verification disabled], header text fragment = [verification disabled], recorded content size = 268
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, null, null, null, null);		// Test [35] <- Index 35
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0036 = "webrtcexperiment-webrtc.netdna-ssl.com";
		int    requestPort0036 = 443;
		String requestFile0036 = "/gif-recorder.js";
		String requestHeader0036 = "GET " + requestFile0036 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				"Host: webrtcexperiment-webrtc.netdna-ssl.com\r\n" + 
				"Connection: Keep-Alive\r\n" + 
				"User-Agent: " + USER_AGENT_1 + "\r\n" + 
				"Accept: */*\r\n" + 
				"DNT: 1\r\n" + 
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 3632
		// content test algorithm: check size +/- 5%, defined content size = 3632
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 3632, 5);		// Test [36] <- Index 36
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0037 = "webrtcexperiment-webrtc.netdna-ssl.com";
		int    requestPort0037 = 443;
		String requestFile0037 = "/gumadapter.js";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 3379
		// content test algorithm: check size +/- 5%, defined content size = 3379
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 3379, 5);		// Test [37] <- Index 37
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0038 = "webrtcexperiment-webrtc.netdna-ssl.com";
		int    requestPort0038 = 443;
		String requestFile0038 = "/getScreenId.js";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 1452
		// content test algorithm: check size +/- 5%, defined content size = 1452
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 1452, 5);		// Test [38] <- Index 38
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0039 = "104.199.121.153";
		int    requestPort0039 = 443;
		String requestFile0039 = "/student/img/lp_search.png";
		...
		// verify response: status code = [verification disabled], content type = [verification disabled], header text fragment = [verification disabled], recorded content size = 10098
		// content test algorithm: none - no content check
		...
		String requestHost0040 = "104.199.121.153";
		int    requestPort0040 = 443;
		String requestFile0040 = "/student/show/%7B%7B%20hash%20%7D%7D";
		...
		// verify response: status code = [verification disabled], content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 40739
		// content test algorithm: search text
		urlCallPassed = httpResponseOk(testURL, threadStep, null, "TEXT/HTML", null, "lookupObject[originalArray[i][prop]] = originalArray[i];");		// Test [40] <- Index 40
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
	...
	boolean executePage_1_2(int totalLoopCounter, LoadtestPluginContext loopPluginContext, InnerLoopContext innerLoopContext, Object httpLogVectorObject) throws Exception
	{
		...
		String requestHost0041 = "webrtcexperiment-webrtc.netdna-ssl.com";
		int    requestPort0041 = 443;
		String requestFile0041 = "/RecordRTC.js";
		...
		// verify response: status code = 200, content type = "APPLICATION/JAVASCRIPT", header text fragment = [verification disabled], recorded content size = 32029
		// content test algorithm: check size +/- 5%, defined content size = 32029
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "APPLICATION/JAVASCRIPT", null, 32029, 5);		// Test [41] <- Index 41
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0042 = "104.199.121.153";
		int    requestPort0042 = 443;
		String requestFile0042 = "/student/img/lp_search.png";
		...
		String requestHost0043 = "104.199.121.153";
		int    requestPort0043 = 443;
		String requestFile0043 = "/img/question/1_question1.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 962082
		// content test algorithm: check size +/- 5%, defined content size = 962082
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 962082, 5);		// Test [43] <- Index 43
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0044 = "104.199.121.153";
		int    requestPort0044 = 443;
		String requestFile0044 = "/student/show/save_audio_to_disk";
		byte[][] requestContent0044 = new byte[10][];
			requestContent0044[0] = "------WebKitFormBoundary2tYbiFvU07PCO1ly\r\n".getBytes();
			requestContent0044[1] = "Content-Disposition: form-data; name=\"audio-filename\"\r\n".getBytes();
			requestContent0044[2] = "\r\n".getBytes();
			requestContent0044[3] = "20_1_3728761094667485.wav\r\n".getBytes();
			requestContent0044[4] = "------WebKitFormBoundary2tYbiFvU07PCO1ly\r\n".getBytes();
			requestContent0044[5] = "Content-Disposition: form-data; name=\"audio-blob\"; filename=\"blob\"\r\n".getBytes();
			requestContent0044[6] = "Content-Type: audio/wav\r\n".getBytes();
			requestContent0044[7] = "\r\n".getBytes();
			requestContent0044[8] = Lib.mergeByteArrays(contentFromDiskFile("blob"), "\r\n".getBytes());
			requestContent0044[9] = "------WebKitFormBoundary2tYbiFvU07PCO1ly--\r\n".getBytes();
		byte[] binaryRequestContent0044 = Lib.mergeByteArrays(requestContent0044);
		String requestHeader0044 = "POST " + requestFile0044 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				"Host: 104.199.121.153\r\n" + 
				"Connection: Keep-Alive\r\n" + 
				"Content-Length: " + binaryRequestContent0044.length + "\r\n" + 		// Content-Length: 78177
				"Origin: https://104.199.121.153\r\n" + 
				"X-CSRF-TOKEN: 9SOwz03aNlUULkLCNXvbruk14riFxL0ebXIwaCcr\r\n" + 
				"User-Agent: " + USER_AGENT_1 + "\r\n" + 
				"Content-Type: multipart/form-data; boundary=----WebKitFormBoundary2tYbiFvU07PCO1ly\r\n" + 
				"Accept: */*\r\n" + 
				"DNT: 1\r\n" + 
				"Accept-Encoding: gzip, deflate, br\r\n" + 
				"Accept-Language: en-US,en;q=0.8\r\n" + 
		...
		// execute request
		testURL = new HttpTestURL(requestProt0044, requestHost0044, requestPort0044, requestHeader0044, binaryRequestContent0044, requestTimeout, socketPool, cookieHandler, httpLogVectorObject);
		testURL.setDNSContext(userDNSContext);
		performanceData.setInfoText(threadStep, testURL, -1);		// hint: param #3 is the maximum acceptable response time in milliseconds (-1 = not configured)
		log("[" + threadStep + "] " + testURL.getRequestInfoText() + " ...");
		if (debugLoops)
		...
		// verify response: status code = [verification disabled], content type = [verification disabled], header text fragment = [verification disabled], recorded content size = 105
		// content test algorithm: none - no content check
		...
		String requestHost0045 = "104.199.121.153";
		int    requestPort0045 = 443;
		String requestFile0045 = "/img/question/1_question2.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 1969881
		// content test algorithm: check size +/- 5%, defined content size = 1969881
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 1969881, 5);		// Test [45] <- Index 45
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0046 = "104.199.121.153";
		int    requestPort0046 = 443;
		String requestFile0046 = "/img/question/1_question3.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 3350004
		// content test algorithm: check size +/- 5%, defined content size = 3350004
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 3350004, 5);		// Test [46] <- Index 46
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0047 = "104.199.121.153";
		int    requestPort0047 = 443;
		String requestFile0047 = "/img/question/1_question4.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 1321090
		// content test algorithm: check size +/- 5%, defined content size = 1321090
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 1321090, 5);		// Test [47] <- Index 47
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0048 = "104.199.121.153";
		int    requestPort0048 = 443;
		String requestFile0048 = "/student/show/save_audio_to_disk";
		byte[][] requestContent0048 = new byte[10][];
			requestContent0048[0] = "------WebKitFormBoundaryyEss5nlZoq1lcPia\r\n".getBytes();
			requestContent0048[1] = "Content-Disposition: form-data; name=\"audio-filename\"\r\n".getBytes();
			requestContent0048[2] = "\r\n".getBytes();
			requestContent0048[3] = "20_1_43024995139464517.wav\r\n".getBytes();
			requestContent0048[4] = "------WebKitFormBoundaryyEss5nlZoq1lcPia\r\n".getBytes();
			requestContent0048[5] = "Content-Disposition: form-data; name=\"audio-blob\"; filename=\"blob\"\r\n".getBytes();
			requestContent0048[6] = "Content-Type: audio/wav\r\n".getBytes();
			requestContent0048[7] = "\r\n".getBytes();
			requestContent0048[8] = Lib.mergeByteArrays(contentFromDiskFile("blob"), "\r\n".getBytes());
			requestContent0048[9] = "------WebKitFormBoundaryyEss5nlZoq1lcPia--\r\n".getBytes();
		byte[] binaryRequestContent0048 = Lib.mergeByteArrays(requestContent0048);
		String requestHeader0048 = "POST " + requestFile0048 + " HTTP/" + httpProtocolVersion + "\r\n" + 
				"Host: 104.199.121.153\r\n" + 
				"Connection: Keep-Alive\r\n" + 
				"Content-Length: " + binaryRequestContent0048.length + "\r\n" + 		// Content-Length: 82274
				"Origin: https://104.199.121.153\r\n" + 
				"X-CSRF-TOKEN: 9SOwz03aNlUULkLCNXvbruk14riFxL0ebXIwaCcr\r\n" + 
				"User-Agent: " + USER_AGENT_1 + "\r\n" + 
				"Content-Type: multipart/form-data; boundary=----WebKitFormBoundaryyEss5nlZoq1lcPia\r\n" + 
				"Accept: */*\r\n" + 
				"DNT: 1\r\n" + 
				"Accept-Encoding: gzip, deflate, br\r\n" + 
				"Accept-Language: en-US,en;q=0.8\r\n" + 
		...
		// execute request
		testURL = new HttpTestURL(requestProt0048, requestHost0048, requestPort0048, requestHeader0048, binaryRequestContent0048, requestTimeout, socketPool, cookieHandler, httpLogVectorObject);
		testURL.setDNSContext(userDNSContext);
		performanceData.setInfoText(threadStep, testURL, -1);		// hint: param #3 is the maximum acceptable response time in milliseconds (-1 = not configured)
		log("[" + threadStep + "] " + testURL.getRequestInfoText() + " ...");
		if (debugLoops)
		...
		// verify response: status code = [verification disabled], content type = [verification disabled], header text fragment = [verification disabled], recorded content size = 106
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, null, null, null, null);		// Test [48] <- Index 48
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0049 = "104.199.121.153";
		int    requestPort0049 = 443;
		String requestFile0049 = "/img/question/1_question5.png";
		...
		// verify response: status code = 200, content type = "IMAGE/PNG", header text fragment = [verification disabled], recorded content size = 1789793
		// content test algorithm: check size +/- 5%, defined content size = 1789793
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {200}, "IMAGE/PNG", null, 1789793, 5);		// Test [49] <- Index 49
		if (!urlCallPassed)
		{
			// failure but continue current loop: mark pending transactions as defective and dump URL content to thread log
			transactionHandler.setPendingTransactionsAsDefective();
		...
		String requestHost0050 = "104.199.121.153";
		int    requestPort0050 = 443;
		String requestFile0050 = "/sound/Keep_Going.mp3";
		...
		// verify response: status code = 206, content type = "AUDIO/MPEG", header text fragment = [verification disabled], recorded content size = 571476
		// content test algorithm: check size +/- 5%, defined content size = 571476
		urlCallPassed = httpResponseOk(testURL, threadStep, new int[] {206}, "AUDIO/MPEG", null, 571476, 5);		// Test [50] <- Index 50
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		log();
		log("# title: Redirecting to https://104.199.121.153");
		String requestProt0051 = "https";
		String requestHost0051 = "104.199.121.153";
		int    requestPort0051 = 443;
		String requestFile0051 = "/logout";
		...
		// verify response: status code = [verification disabled], content type = [verification disabled], header text fragment = [verification disabled], recorded content size = 336
		// content test algorithm: none - no content check
		urlCallPassed = httpResponseOk(testURL, threadStep, null, null, null, null);		// Test [51] <- Index 51
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
		...
		String requestHost0052 = "104.199.121.153";
		int    requestPort0052 = 443;
		String requestFile0052 = "/";
		...
		// verify response: status code = [verification disabled], content type = "TEXT/HTML", header text fragment = [verification disabled], recorded content size = 18386
		// content test algorithm: search text
		urlCallPassed = httpResponseOk(testURL, threadStep, null, "TEXT/HTML", null, "Touch styles for more information");		// Test [52] <- Index 52
		if (!urlCallPassed)
		{
			// failure - dump wrong content to thread log and abort current loop
			terminateFailedUser(testURL);		// set the user to be terminated at end of loop ? - only performed if the URL call has marked before to support that !
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("spiraltest1", concurrentUsers);
		...
		performanceData.setInfoText("spiraltest1");
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				spiraltest1 simulatedUser = new spiraltest1(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
