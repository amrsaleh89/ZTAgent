...
// -----------------------------------------
//
// Source: ww20170314e.java
// Date  : 16 Mar 2017 14:20:12 PST
 ...
 * Automatically generated load test program.
 */
public class ww20170314e extends HttpLoadTest implements Runnable, ThreadStepInterface, SetThreadStepInterface, SSLSessionCacheStatisticInterface, VaryingLoadInterface, VaryingTestDurationInterface, SuspendResumeInterface, GetRealTimeUserInputFieldsInterface
{
	...
	private static final String EXTERNAL_PARAM_FILE = "ww20170314eExtParams.dat";           // input file name for very large parameter values
	 ...
	 */
	public ww20170314e(int maxLoops, int requestTimeout, int threadNumber)
	{
		super();
	...
	public static void main(String[] args)
	{
		...
		String genericFileName = PerformanceData.proposeFileName("ww20170314e", concurrentUsers);
		...
		performanceData.setInfoText("ww20170314e");
		...
		LoadtestPluginContext globalPluginContext = new LoadtestPluginContext(prxVersion, prxCharEncoding, new ww20170314e());
		try
		{
		...
		for (int x = 0; x < concurrentUsers; x++)
		{
			...
			try
			{
				...
				ww20170314e simulatedUser = new ww20170314e(maxPlannedLoops, plannedRequestTimeout, getUserContextTable().getUserContextList().size());
